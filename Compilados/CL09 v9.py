...
directory = r'C:\Users\m0081459\Documents\1_Proyectos\1_OBCP\1_Validation\8_Test results\D3_1\Ensayos Piezas D3_1\CL09\DCDC\Ejemplo'
os.chdir(directory)
...
#Titulo
test = val_phase + " " + sn + " - Prueba calculos"
...
HV_AC_labels_P = HV_AC_labels_P + ["P_in"]
"""
data_plot = data[['Measurement'] + status_labels+HV_AC_labels_V+HV_AC_labels_I+HV_AC_labels_P+HV_DC_labels_V+HV_DC_labels_I+HV_DC_labels_P+LV_DC_labels+temperature_labels+dl1_labels+dl2_labels+['PS_relay_status']].copy()
...
roundup = data.astype(float).copy()


# In[6]:


redondeo = roundup['C_chamber_T_actl'].round()
